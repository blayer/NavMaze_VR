...
function Stack(){
	...
	Cell.prototype = {
		...
		{   w=this.size/2;
			...
			var landmarkMaterial = new THREE.MeshPhongMaterial( { map: imgTexture, color: 0xffffff, ambient: 0xF0EFEF, specular: 0x999999, shininess: 15, perPixel: true, shading: THREE.SmoothShading } );
		...
		drawWall: function( x, y, x2, y2, dir ){
			...
			var wallGeo = new THREE.CubeGeometry( w, wallH, 32 ); //CubeGeometry (width,height,depth)
